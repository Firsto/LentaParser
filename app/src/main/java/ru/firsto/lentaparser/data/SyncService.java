...
import ru.firsto.lentaparser.util.AndroidComponentUtil;
import ru.firsto.lentaparser.util.NetworkUtil;
import rx.Observer;
...
public class SyncService extends Service {
    ...
    public void onCreate() {
        super.onCreate();
        LentaParserApplication.get(this).component().inject(this);
    }
